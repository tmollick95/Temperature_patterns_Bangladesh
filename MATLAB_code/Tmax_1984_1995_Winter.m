...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Extract longitude and latitude
longitude = winter1984err(:, 1);
latitude = winter1984err(:, 2);

% Extract temperature data from column 3, 7, 11, ... (January months)
num_columns = size(winter1984err, 2);
january_indices = 3:4:num_columns;

% Calculate the mean of all January months
mean_january_error = mean(winter1984err(:, january_indices), 2);

% Combine longitude, latitude, and mean January temperatures into a new matrix
winter1984prerr = [longitude, latitude, mean_january_error];
...
% Release the plot hold
hold off;
print(gcf, ' Error Map of January - 1984 - 1995.jpg', '-djpeg', '-r300');
...
actual_values = winter1984prtemp(:, 3);
error_values = winter1984prerr(:, 3);
...
grid on;
hold off;
print(gcf, 'Cross Validation Actual vs Predicted Temperature of January (1984 - 1995).jpg', '-djpeg', '-r300');
...
Predicted_temp = winter1984pr(:, 3:end); % Replace with your actual data
...
title('d) Winter (1984 - 1995)');

% Adjust legend properties
legend('Location', 'northeast', 'FontSize', 8); % Smaller font size for the legend
legend boxoff; % Remove box around the legend
grid on;
print(gcf, 'Timeseries Average Maximum Temperatures of Winter (1984 - 1995).jpg', '-djpeg', '-r300');
