...
hold off;
print(gcf, ' Predicted Maximum Temperature of April - 2008 - 2017.jpg', '-djpeg', '-r300');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Extract longitude and latitude
longitude = summer2008err(:, 1);
latitude = summer2008err(:, 2);

% Extract error data from column 3, 7, 11, ... (April months)
num_columns = size(summer2008err, 2);
april_indices = 3:4:num_columns;

% Calculate the mean of all April months
mean_april_error = mean(summer2008err(:, april_indices), 2);

% Combine longitude, latitude, and mean May temperatures into a new matrix
summer2008prerr = [longitude, latitude, mean_april_error];

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generate error map or figures for Ordinary Kriging prediction
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

err2008 = summer2008prerr;
...
% Release the plot hold
hold off;
print(gcf, ' Error Map of April - 2008 - 2017.jpg', '-djpeg', '-r300');
...
actual_values = summer2008prtemp(:, 3);
error_values = summer2008prerr(:, 3);
...
Z = Mat(17, 3:end)';  % Temperature data, transposed to have columns as different datasets
cal_var = var(Z);
...
grid on;
hold off;
print(gcf, 'Cross Validation Actual vs Predicted Temperature of April (2008 - 2017).jpg', '-djpeg', '-r300');
...
Predicted_temp = summer2008pr(:, 3:end); % Replace with your actual data
