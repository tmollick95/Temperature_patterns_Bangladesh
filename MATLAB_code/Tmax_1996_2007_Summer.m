...
hold off;
print(gcf, ' Predicted Maximum Temperature of April - 1996 - 2007.jpg', '-djpeg', '-r300');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Extract longitude and latitude
longitude = summer1996err(:, 1);
latitude = summer1996err(:, 2);

% Extract error data from column 3, 7, 11, ... (April months)
num_columns = size(summer1996err, 2);
april_indices = 3:4:num_columns;

% Calculate the mean of all April months
mean_april_error = mean(summer1996err(:, april_indices), 2);

% Combine longitude, latitude, and mean May temperatures into a new matrix
summer1996prerr = [longitude, latitude, mean_april_error];
...
% Release the plot hold
hold off;
print(gcf, ' Error Map of April - 1996 - 2007.jpg', '-djpeg', '-r300');
...
actual_values = summer1996prtemp(:, 3);
error_values = summer1996prerr(:, 3);
...
grid on;
hold off;
print(gcf, 'Cross Validation Actual vs Predicted Temperature of April (1996 - 2007).jpg', '-djpeg', '-r300');
...
Predicted_temp = summer1996pr(:, 3:end); % Replace with your actual data
